...
public interface ClientRoSessionListener {
   ...
   * @throws OverloadException The OverloadException signals that destination host is overloaded.
   */
  void doRequestTimeout(ClientRoSession session, Message msg, Peer peer) throws InternalException, IllegalDiameterStateException, RouteException, OverloadException;
   ...
   * @throws OverloadException The OverloadException signals that destination host is overloaded.
   */
  void doPeerUnavailability(RouteException cause, ClientRoSession session, Message msg, Peer peer) throws InternalException, IllegalDiameterStateException, RouteException, OverloadException;
